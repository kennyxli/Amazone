        ...
        if (this.props.reviews){
            ...
            <div className='review-body'>
                ...
                <h2 key={this.props.product.id}>
                    ...
                    <ul>
                                <li><a href={`#product/${this.props.product.id}`}>5 star<button><input type="submit" className="inner-review-button" style={{ width: `${num5 === 0 ? 0 : ((num5 / num) * 100) + 8}%` }} value="" /></button>{Math.floor((num5 / num) * 100) ? Math.floor((num5 / num) * 100): 0}%</a></li>
                                <li><a href={`#product/${this.props.product.id}`}>4 star<button><input type="submit" className="inner-review-button" style={{ width: `${num4 === 0 ? 0 : ((num4 / num) * 100) + 8}%` }} value="" /></button>{Math.floor((num4 / num) * 100) ? Math.floor((num4 / num) * 100) : 0}%</a></li>
                                <li><a href={`#product/${this.props.product.id}`}>3 star<button><input type="submit" className="inner-review-button" style={{ width: `${num3 === 0 ? 0 : ((num3 / num) * 100) + 8}%` }} value="" /></button>{Math.floor((num3 / num) * 100) ? Math.floor((num3 / num) * 100) : 0}%</a></li>
                                <li><a href={`#product/${this.props.product.id}`}>2 star<button><input type="submit" className="inner-review-button" style={{ width: `${num2 === 0 ? 0 : ((num2 / num) * 100) + 8}%` }} value="" /></button>{Math.floor((num2 / num) * 100) ? Math.floor((num2 / num) * 100) : 0}%</a></li>
                                <li><a href={`#product/${this.props.product.id}`}>1 star<button><input type="submit" className="inner-review-button" style={{ width: `${num1 === 0 ? 0 : ((num1 / num) * 100) + 8}%` }} value="" /></button>{Math.floor((num1 / num) * 100) ? Math.floor((num1 / num) * 100) : 0}%</a></li>
                    </ul>
