                ...
                <form>
                    ...
                    <label className="login-param">Password:
                        ...
                        <button className="signbutton"  onClick={this.handleDemo}>Demo Sign-In</button>
                            ...
                            <p className="signcond">By continuing, you agree to Amazone's <a target="_blank" href="https://www.linkedin.com/in/kenny-li-793b6b15b/" className="form-hyperlink">Conditions of <br /> Use</a> and <a target="_blank" href="https://www.linkedin.com/in/kenny-li-793b6b15b/" className="form-hyperlink">Privacy Notice.</a></p>
                    </div>
                </form>
            </div>
